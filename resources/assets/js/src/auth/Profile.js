        ...
        return (
            <div className="user-panel">
                ...
                <div className="user-panel__info">
                    <p className="user-panel__info-title">
                        Developed by <a href="https://www.linkedin.com/in/popovserge/" target="_blank"><i className="fab fa-linkedin-in"></i>Popov Sergey</a>
                    </p>
